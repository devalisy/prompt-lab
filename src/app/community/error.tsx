...
export default function CommunityError({ error: _error, reset }: { error: Error; reset: () => void }) {
  return (
    <main className="pt-24 pb-16 min-h-screen">
      <div className="max-w-5xl mx-auto px-4 text-center py-20">
        ...
        <p className="text-sm text-text-secondary mb-4">تعذر تحميل صفحة المجتمع</p>
